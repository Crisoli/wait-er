                ...
                <div class="card large">
                    ...
                    <div class="card-tabs">
                        <ul class="tabs tabs-fixed-width" class="black-text">
                            <li class="tab"><a class="active black-text" href="#status">Status</a></li>
                            <li class="tab"><a class="black-text" href="#itens">Itens</a></li>
                            <li class="tab"><a class="black-text" href="#anotacoes">Anotações</a></li>
                        </ul>
                    </div>
